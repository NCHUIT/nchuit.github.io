              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-gray-600">台中市南區興大路145號</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-gray-600">nchuit@example.com</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-gray-600">(04) 2287-0000</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li className="flex justify-between">
                  <span>週一至週五</span>
                  <span>下午 2:00 - 晚上 9:00</span>
                </li>
                <li className="flex justify-between">
                  <span>週六</span>
                  <span>上午 10:00 - 下午 6:00</span>
                </li>
                <li className="flex justify-between">
                  <span>週日</span>
                  <span>休息</span>
