...
const oldCoursesData = [
  {
    id: "python-ecommerce",
    title: "Python 全端智能電商實戰",
    image: getImagePath("images/courses/python-ecommerce.jpg"),
    description: [
      "這門課程將帶你用 6 堂課深入學習 Python Flask 的網站開發全流程，由前端到後端、從資料庫設計到智慧客服，實作經驗一步到位！",
      [
        "這門課將會使用 ",
  ...
  },
  {
    ...
    description: [
      ...
      "如果是有缺統合學分的同學，不妨可以考慮看看！參加這個跨域興學習的同學可以獲得 1 統合學分！",
    ],
    info: [
      "課程日期：3/12 ~ 6/4（每週三）",
